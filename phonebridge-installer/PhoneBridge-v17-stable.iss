...
OutputDir=out-v17-stable
OutputBaseFilename=PhoneBridge-v1.7-Stable-Setup
...
[Files]
Source: "payload-v17-stable\PhoneBridge.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "payload-v17-stable\Camera\PhoneBridgeVirtualCameraSetup.exe"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v17-stable\Camera\VirtualCameraMediaSource.dll"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v17-stable\Camera\PhoneBridgeCameraProbe.exe"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v17-stable\Android\PhoneBridge-v1.6.apk"; DestDir: "{app}\Android"; Flags: ignoreversion
Source: "payload-v17-stable\README-New-PC.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "payload-v17-stable\SHA256.txt"; DestDir: "{app}"; Flags: ignoreversion
