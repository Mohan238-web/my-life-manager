...
OutputDir=out
OutputBaseFilename=PhoneBridge-v1.0-Setup
Compression=lzma2
...
[Files]
Source: "payload\PhoneBridge.exe"; DestDir: "{app}"; DestName: "PhoneBridge.exe"; Flags: ignoreversion
Source: "payload\PhoneBridgeVirtualCameraSetup.exe"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload\VirtualCameraMediaSource.dll"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload\PhoneBridge-v1.apk"; DestDir: "{app}\Android"; Flags: ignoreversion
