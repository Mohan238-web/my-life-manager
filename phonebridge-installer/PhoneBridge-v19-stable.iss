...
OutputDir=out-v19-stable
OutputBaseFilename=PhoneBridge-v1.9-Stable-Setup
...
[Files]
Source: "payload-v19-stable\PhoneBridge.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "payload-v19-stable\Camera\PhoneBridgeVirtualCameraSetup.exe"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v19-stable\Camera\VirtualCameraMediaSource.dll"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v19-stable\Camera\PhoneBridgeCameraProbe.exe"; DestDir: "{app}\Camera"; Flags: ignoreversion
Source: "payload-v19-stable\Android\PhoneBridge-v1.9.apk"; DestDir: "{app}\Android"; Flags: ignoreversion
Source: "payload-v19-stable\README-New-PC.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "payload-v19-stable\SHA256.txt"; DestDir: "{app}"; Flags: ignoreversion
