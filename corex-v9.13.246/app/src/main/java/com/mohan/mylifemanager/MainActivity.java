...
public final class MainActivity extends Activity {
    ...
    private static final String NOTIFICATION_PROMPTED = "notification_prompted_v913246";
    ...
    private void requestNotificationPermissionOnce() {
        ...
        if (getSharedPreferences(RUNTIME_PREFS, MODE_PRIVATE).getBoolean(NOTIFICATION_PROMPTED, false)) return;
        getSharedPreferences(RUNTIME_PREFS, MODE_PRIVATE).edit().putBoolean(NOTIFICATION_PROMPTED, true).apply();
