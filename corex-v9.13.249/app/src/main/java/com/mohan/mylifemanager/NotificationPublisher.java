...
final class NotificationPublisher {
    static final String CHANNEL_ID = "corex_reminders_v2";
    ...
    static boolean show(Context context, String rawPayload) {
        try {
            ...
            String title = payload.optString("title", "Corex");
            String body = payload.optString("body", "Open Corex to review this reminder.");
